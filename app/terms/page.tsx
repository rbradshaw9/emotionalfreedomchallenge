      ...
      <div className="container container-md">
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            ("the Challenge"), you agree to be bound by these Terms of Use. If you do not agree 
        ...
        <section className={styles.section}>
          ...
          <p>
            The Challenge is provided "as is" without warranties of any kind, either express or 
